...
class FunctionNode {
 ...
 public:
  ...
  // True only when an address is backed by a discovered/emittable code block.
  // Unlike containsAddress(), this deliberately does NOT trust the broad
  // PDATA/CONFIG declared range because a gap in that range has no C++ label.
