...
class BaseHeap {
 ...
 protected:
  ...
  // Xenia Canary cdd6049 free-block allocator adapted to ReXGlue's AOT heap.
  // The map stores start_page -> contiguous free page count and avoids scanning
  // the full page table for every allocation.
  ...
  // Auxiliary free block tracker. Not serialized; rebuilt after Restore.
