...
class IGraphicsSystem {
 public:
  ...
  // Xbox 360 hardware scaler aspect ratio state. Mirrors Xenia cdd6049.
  virtual std::pair<uint32_t, uint32_t> GetScaledAspectRatio() const {
    return {16, 9};
  }
  virtual void SetScaledAspectRatio(uint32_t x, uint32_t y) {
    (void)x;
    (void)y;
  }
