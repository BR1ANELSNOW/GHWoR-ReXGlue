...
// Sleeps with the highest-resolution platform primitive available. The Windows
// implementation mirrors Xenia Canary and uses NtDelayExecution in 100 ns
// increments.
void NanoSleep(int64_t ns);
void NanoSleepPrecise(int64_t ns);

#if REX_PLATFORM_WIN32
// Requests the same host timer resolution and MMCSS opt-in as Xenia Canary.
