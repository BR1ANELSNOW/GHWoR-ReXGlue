...
#include <rex/graphics/d3d12/d3d12_zpd_query_pool.h>
...
class D3D12CommandProcessor : public CommandProcessor {
 public:
  ...
  // Native guest-output renderers need read-only access to the guest-visible
  // GPU memory backing vertex, index and texture data.
 ...
 private:
  ...
  // Xenia cdd6049 ZPD occlusion backend.
